...
class Pds::IocOccurrence : public Pds::Routine {
  public:
    ...
    ~IocOccurrence();
    void iocControlError(const std::string& msg, const std::string& expt, unsigned run, unsigned stream, unsigned chunk);
  ...
  private:
    class Message {
      ...
      public:
        ...
        Message(const std::string& msg, const std::string& expt, unsigned run, unsigned stream, unsigned chunk);
      private:
        std::string _msg;
        std::string _expt;
        unsigned    _run;
