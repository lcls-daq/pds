/*
 * Epix10kaStatusRegisters.hh
 *
 *  Created on: 2017.10.27
 *      Author: jackp
 */

#ifndef EPIX10KASSTATUSREGISTERS_HH_
#define EPIX10KASSTATUSREGISTERS_HH_
...
namespace Pds {
  ...
  namespace Epix10ka {
    ...
    //  </status>
        ...
        class Epix10kaStatusRegisters {
          public:
            Epix10kaStatusRegisters() {};
            ~Epix10kaStatusRegisters() {};
          ...
          public:
            ...
            StatusLane      lane;
            unsigned        txCounter;
            unsigned        AdcChipIdReg;
            unsigned        AdcChipGradeReg;
        };
...
#endif /* EPIX10KASSTATUSREGISTERS_HH_ */
