...
////////////////////////////////////////////////////////////////////////////////
extern "C" const gchar _binary_piGui_main_window_ui_start[];
extern "C" const gchar _binary_piGui_main_window_ui_end[];
extern "C" const gchar _binary_piGui_cameras_dialog_ui_start[];
extern "C" const gchar _binary_piGui_cameras_dialog_ui_end[];
extern "C" const gchar _binary_piGui_repetitive_gate_dialog_ui_start[];
extern "C" const gchar _binary_piGui_repetitive_gate_dialog_ui_end[];
extern "C" const gchar _binary_piGui_exposure_dialog_ui_start[];
extern "C" const gchar _binary_piGui_exposure_dialog_ui_end[];
extern "C" const gchar _binary_piGui_parameters_dialog_ui_start[];
extern "C" const gchar _binary_piGui_parameters_dialog_ui_end[];
...
void ConfigureFromParametersDialog()
{
    ...
    parameters_ =
        LoadDialog(
            _binary_piGui_parameters_dialog_ui_start,
            _binary_piGui_parameters_dialog_ui_end );
    if( !parameters_ )
        return;
...
void InitializeExposureDialog()
{
    ...
    exposure_ =
        LoadDialog(
            _binary_piGui_exposure_dialog_ui_start,
            _binary_piGui_exposure_dialog_ui_end );
    if( !exposure_ )
        return;
...
void InitializeRepetitiveGateDialog()
{
    ...
    repetitiveGate_ =
        LoadDialog(
            _binary_piGui_repetitive_gate_dialog_ui_start,
            _binary_piGui_repetitive_gate_dialog_ui_end );
    if( !repetitiveGate_ )
        return;
...
const PicamCameraID* SelectFromCamerasDialog()
{
    ...
    GtkBuilder* builder =
        LoadDialog(
            _binary_piGui_cameras_dialog_ui_start,
            _binary_piGui_cameras_dialog_ui_end );
    if( !builder )
        return 0;
...
pibool InitializeMainWindow()
{
    ...
    GtkBuilder* builder = gtk_builder_new();
    const gchar* ui = _binary_piGui_main_window_ui_start;
    gint size =
        _binary_piGui_main_window_ui_end -
        _binary_piGui_main_window_ui_start;
    GError* error = 0;
