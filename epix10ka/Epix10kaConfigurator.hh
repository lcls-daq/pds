/*
 * Epix10kaConfigurator.hh
 *
 *  Created on: 2017.10.27
 *      Author: jackp
 */

#ifndef EPIX10KA_CONFIGURATOR_HH_
#define EPIX10KA_CONFIGURATOR_HH_
...
//                                        //0x7735940 //  1 Hz
    ...
    class Epix10kaConfigurator : public Pds::Pgp::Configurator {
      public:
        Epix10kaConfigurator(int, unsigned);
        virtual ~Epix10kaConfigurator();

        enum resultReturn {Success=0, Failure=1, Terminate=2};

        unsigned             configure(Epix10kaConfigType*, unsigned first=0);
        Epix10kaConfigType&  configuration() { return *_config; };
        void                 print();
        void                 dumpFrontEnd();
        void                 printMe();
        ...
        Epix10kaConfigShadow* shadow() { return _s; }
      ...
      private:
        ...
        Epix10kaConfigType*         _config;
        Epix10kaConfigShadow*       _s;
        Epix10kaDestination         _d;
        unsigned*                   _rhisto;
...
#endif /* EPIX10KA_CONFIGURATOR_HH_ */
